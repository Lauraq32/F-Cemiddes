...
const Products = () => {
  ...
  const saveProduct = () => {
    ...
    if (product.name.trim()) {
      ...
      if (product._id) {
        axios
          .put(
            `${process.env.REACT_APP_API_URL}/api/products/` + _product._id,
            _product,
            { headers: getHeaders() }
          )
          .then((response) => {
        ...
        axios
          .post(`${process.env.REACT_APP_API_URL}/api/products`, _product, {
            headers: getHeaders(),
          })
          .then((response) => {
            toast.current.show({
  ...
  const onCalenderChange = (e) => {
    const value = e.value;
    const fields = { ...product, date: value };
    setProduct(fields);
  };
  ...
  const nameBodyTemplate = (rowData) => {
    return <NavLink to={`/products/${rowData._id}`}>{rowData.name}</NavLink>;
  };
  ...
  const statusOptions = [
    { id: 1, name: "Lleno", status: "lleno" },
    { id: 2, name: "Bajito", status: "bajito" },
  ];
  ...
  const updateStatus = (e) => {
    setStatus(e.value);
    setProduct({ ...product, status: e.value.status });
  };
      ...
      <div className="col-12">
        <div className="card">
          ...
          >
            ...
            <Column
              field="status"
              header="Estado de los productos"
          ...
          <Dialog
            ...
            style={{ width: "450px" }}
            header="Detalles de los productos"
            modal
            className="p-fluid"
            ...
            <div className="formgrid grid">
              ...
              <div className="field col">
                ...
                {submitted && !product.price && (
                  <small className="p-invalid">el precio es necesario.</small>
                )}
              </div>
            </div>
            <div className="field">
          ...
          {dialogIsVisible && (
            ...
            >
              <div className="modal-content">
                <p>
                  <b>Nombre:</b> {dialogContent.name}
                </p>
                <p>
                  <b>Cantidad:</b> {dialogContent.amount}
                </p>
                <p>
